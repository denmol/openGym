...
export default function Login() {
  ...
  const head = <>
    ...
    <h1 style={{ fontSize: 34, fontWeight: 700, letterSpacing: '-.028em', margin: '10px 0 4px' }}>Dagsnav</h1>
  </>
  ...
  if (DEMO) return (
    <div className="narrow" style={wrap}>
      ...
      <div className="card small muted" style={{ textAlign: 'left', marginTop: 16 }}>
        {t('This demo runs entirely in your browser on example data — nothing is sent anywhere. Passkey sign-in and sync across your devices come with the Dagsnav server, which you get by self-hosting it.')}
      </div>
  ...
  return (
    <div className="narrow" style={wrap}>
      ...
      {webauthnOK() ? <>
        ...
        <div style={{ height: 10 }} />
      </> : <div className="card small muted" style={{ textAlign: 'left' }}>{t("This browser doesn't support passkeys — you can still use Dagsnav locally on this device.")}</div>}
